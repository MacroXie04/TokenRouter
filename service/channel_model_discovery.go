...
func channelSupportsUpstreamModelDiscovery(channelType constant.ChannelType) bool {
	switch channelType {
...
func buildAdvancedCustomModelDiscoveryPlan(channel *model.Channel, baseURL, credential string) (channelModelDiscoveryPlan, error) {
	...
	if err := common.UnmarshalJsonStr(strings.TrimSpace(channel.OtherSettings), &settings); err != nil || settings.AdvancedCustom == nil {
