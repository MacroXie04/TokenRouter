...
func loadUserSessionPolicy() (userSessionPolicy, error) {
	...
	windowSeconds, err := strictScheduledIntegerEnv(
	...
	retentionDays, err := strictScheduledIntegerEnv(
	...
	alertThreshold, err := strictScheduledIntegerEnv(
