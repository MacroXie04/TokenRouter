...
func TestLegacyEntitlementReviewRequiresRootAndCommitsImmutableAudit(t *testing.T) {
	...
	root := &model.User{Username: "legacy-entitlement-root", Password: "x", Role: constant.RoleRootUser,
		Status: model.UserStatusEnabled, Group: "default"}
	admin := &model.User{Username: "legacy-entitlement-admin", Password: "x", Role: constant.RoleAdminUser,
		Status: model.UserStatusEnabled, Group: "default"}
