...
func TelegramBotName() string {
	name := common.GetEnv("TELEGRAM_BOT_NAME", setting.GetOptionOrDefault(telegramBotNameOption, ""))
...
func telegramBotToken() string {
	return common.GetEnv("TELEGRAM_BOT_TOKEN", setting.GetOptionOrDefault(telegramBotTokenOption, ""))
}
