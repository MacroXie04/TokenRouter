...
func ComputeBillingQuotaForUser(modelName, userGroup, usingGroup string, isClaude bool, u *protocolkit.Usage, req billingexpr.RequestInput) (int, *common.QuotaClamp, error) {
...
func computeTieredQuotaForUser(modelName, userGroup, usingGroup string, isClaude bool, u *protocolkit.Usage, req billingexpr.RequestInput, exprStr string) (int, *common.QuotaClamp, error) {
