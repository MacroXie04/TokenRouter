...
func writeAdminSubscriptionError(c *gin.Context, err error) {
	if errors.Is(err, billingsvc.ErrSubscriptionTargetForbidden) {
...
func requirePaymentCompliance(c *gin.Context) bool {
	if !billingsvc.PaymentComplianceConfirmed() {
		c.JSON(http.StatusBadRequest, dto.Fail(billingsvc.ErrPaymentComplianceRequired.Error()))
		return false
	}
	return true
}
...
func AdminListSubscriptionPlans(c *gin.Context) {
	plans, err := billingsvc.AdminListSubscriptionPlans()
	if err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
...
func AdminCreateSubscriptionPlan(c *gin.Context) {
	...
	if err := billingsvc.AdminCreateSubscriptionPlan(&req.Plan); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
...
func AdminUpdateSubscriptionPlan(c *gin.Context) {
	...
	if err := billingsvc.AdminUpdateSubscriptionPlan(id, &req.Plan); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
...
func AdminUpdateSubscriptionPlanStatus(c *gin.Context) {
	...
	if err := billingsvc.AdminUpdateSubscriptionPlanStatus(id, *req.Enabled); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
	c.JSON(http.StatusOK, dto.Ok(nil))
...
func AdminBindSubscription(c *gin.Context) {
	...
	msg, err := billingsvc.AdminBindSubscriptionAuthorized(req.UserId, req.PlanId, requestctx.GetRole(c))
	if err != nil {
...
func AdminListUserSubscriptions(c *gin.Context) {
	...
	subs, err := billingsvc.AdminListUserSubscriptionsAuthorized(userId, requestctx.GetRole(c))
	if err != nil {
		writeAdminSubscriptionError(c, err)
		return
	}
...
func AdminCreateUserSubscription(c *gin.Context) {
	...
	msg, err := billingsvc.AdminBindSubscriptionAuthorized(userId, req.PlanId, requestctx.GetRole(c))
	if err != nil {
		writeAdminSubscriptionError(c, err)
		return
	}
...
func recordSubscriptionResetUserLogs(result *billingsvc.SubscriptionResetResult) {
	...
	for _, userId := range result.AffectedUserIds {
		billingsvc.RecordSystemLog(userId, billingsvc.LogTypeManage, content)
	}
}
...
func AdminResetUserSubscriptionsByPlan(c *gin.Context) {
	...
	result, err := billingsvc.AdminResetUserSubscriptionsByPlanAuthorized(
		userId, req.PlanId, resolveAdvanceResetTime(req.AdvanceResetTime), requestctx.GetRole(c),
	)
	if err != nil {
		writeAdminSubscriptionError(c, err)
		return
...
func AdminResetPlanSubscriptions(c *gin.Context) {
	...
	result, err := billingsvc.AdminResetPlanSubscriptionsAuthorized(
		planId, resolveAdvanceResetTime(req.AdvanceResetTime), requestctx.GetRole(c),
	)
	if err != nil {
		writeAdminSubscriptionError(c, err)
		return
	...
	recordSubscriptionResetUserLogs(result)
	logging.SysLog(fmt.Sprintf("admin reset subscription plan %d quota: reset_count=%d user_count=%d advance_reset_time=%t",
...
func AdminInvalidateUserSubscription(c *gin.Context) {
	...
	msg, err := billingsvc.AdminInvalidateUserSubscriptionAuthorized(subId, requestctx.GetRole(c))
	if err != nil {
		writeAdminSubscriptionError(c, err)
		return
	}
...
func AdminDeleteUserSubscription(c *gin.Context) {
	...
	msg, err := billingsvc.AdminDeleteUserSubscriptionAuthorized(subId, requestctx.GetRole(c))
	if err != nil {
		writeAdminSubscriptionError(c, err)
		return
	}
...
func ResolveLegacySubscriptionEntitlementReview(c *gin.Context) {
	...
	var resolution billingsvc.LegacySubscriptionEntitlementResolution
	if err := c.ShouldBindJSON(&resolution); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail("参数错误"))
		return
	}
	if err := billingsvc.ResolveLegacySubscriptionEntitlementReview(requestctx.GetUserId(c), subscriptionID, resolution); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
	c.JSON(http.StatusOK, dto.Ok(nil))
