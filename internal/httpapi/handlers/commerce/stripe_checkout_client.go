...
func init() {
	billingsvc.RegisterStripeCheckoutResolver(resolveStripeCheckoutSnapshot)
}
...
// idempotency key.
func stripeCheckoutParamsFromSnapshot(snapshot billingsvc.StripeCheckoutRequestSnapshot) *stripe.CheckoutSessionParams {
...
func resolveStripeCheckoutSnapshot(ctx context.Context, snapshot billingsvc.StripeCheckoutRequestSnapshot, existingSessionID string) (*billingsvc.StripeCheckoutResolution, error) {
