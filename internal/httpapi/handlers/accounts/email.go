...
func SendEmailVerification(c *gin.Context) {
	...
	if err := authsvc.SendEmailVerificationCode(normalized); err != nil {
...
func BindEmail(c *gin.Context) {
	...
	if err := authsvc.VerifyAndBindEmail(identity.UserID, req.Email, req.Code); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	_ = authsvc.SendPasswordResetEmail(email)
...
func ResetPassword(c *gin.Context) {
	...
	if generated {
		var err error
		password, err = cryptoutil.SecureRandomAlphanumeric(generatedPasswordLength)
		if err != nil {
	...
	if err := authsvc.ResetPassword(req.Email, credential, password); err != nil {
		c.JSON(http.StatusBadRequest, dto.Fail(err.Error()))
		return
	}
	if generated {
