...
func listModelMetadata(c *gin.Context, keyword string) {
	...
	items, total, err := model.SearchModelMetadata(model.ModelSearchFilter{
		...
		Status:       catalogsvc.ParseModelStatusFilter(c.Query("status")),
		SyncOfficial: catalogsvc.ParseModelSyncFilter(c.Query("sync_official")),
	...
	if err := catalogsvc.EnrichModelMetadata(items); err != nil {
		modelMetadataError(c, err)
		return
	}
...
func GetModelMeta(c *gin.Context) {
	...
	if err := catalogsvc.EnrichModelMetadata([]*model.Model{metadata}); err != nil {
		modelMetadataError(c, err)
		return
	}
...
func CreateModelMeta(c *gin.Context) {
	...
	if err := catalogsvc.ValidateModelMetadata(&metadata, false); err != nil {
		modelMetadataError(c, err)
		return
	}
...
func UpdateModelMeta(c *gin.Context) {
	...
	if err := catalogsvc.ValidateModelMetadata(&metadata, statusOnly); err != nil {
		modelMetadataError(c, err)
		return
	}
