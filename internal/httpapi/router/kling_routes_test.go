...
func TestKlingRoutesUseExactImplementedSurface(t *testing.T) {
	...
	expected := map[string]string{
		"POST /kling/v1/videos/text2video":          "relay.RelayKlingTask",
		"POST /kling/v1/videos/image2video":         "relay.RelayKlingTask",
		"GET /kling/v1/videos/text2video/:task_id":  "relay.RelayKlingTaskFetch",
		"GET /kling/v1/videos/image2video/:task_id": "relay.RelayKlingTaskFetch",
	}
...
func TestKlingImageToVideoSubmitRouteContract(t *testing.T) {
	requireExactKlingRoute(t, http.MethodPost, "/kling/v1/videos/image2video", "relay.RelayKlingTask")
}

func TestKlingTextToVideoFetchRouteContract(t *testing.T) {
	requireExactKlingRoute(t, http.MethodGet, "/kling/v1/videos/text2video/:task_id", "relay.RelayKlingTaskFetch")
}

func TestKlingImageToVideoFetchRouteContract(t *testing.T) {
	requireExactKlingRoute(t, http.MethodGet, "/kling/v1/videos/image2video/:task_id", "relay.RelayKlingTaskFetch")
}
