...
func TestDecideChannelHealthTransition(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "configured status disables", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, AllowDisable: true, Failure: statusFailure}, status: channelcatalog.ChannelStatusAutoDisabled, reason: ChannelTransitionReasonStatusCode},
		{name: "autoban off", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled, AllowDisable: true, Failure: statusFailure}, status: channelcatalog.ChannelStatusEnabled},
		{name: "passive recovery never disables", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, Failure: statusFailure}, status: channelcatalog.ChannelStatusEnabled},
		{name: "manual status unchanged", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusManuallyDisabled, AutoBan: true, AllowDisable: true, Failure: statusFailure}, status: channelcatalog.ChannelStatusManuallyDisabled},
		{name: "latency above threshold disables", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, AllowDisable: true, LatencyMilliseconds: 5001, Failure: ordinaryFailure}, status: channelcatalog.ChannelStatusAutoDisabled, reason: ChannelTransitionReasonLatency},
		{name: "successful but slow probe disables", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, AllowDisable: true, LatencyMilliseconds: 5001}, status: channelcatalog.ChannelStatusAutoDisabled, reason: ChannelTransitionReasonLatency},
		{name: "latency equal threshold stays", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, AllowDisable: true, LatencyMilliseconds: 5000, Failure: ordinaryFailure}, status: channelcatalog.ChannelStatusEnabled},
		{name: "successful recovery", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusAutoDisabled}, status: channelcatalog.ChannelStatusEnabled, reason: ChannelTransitionReasonRecovery},
		{name: "slow passive probe cannot recover", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusAutoDisabled, LatencyMilliseconds: 5001}, status: channelcatalog.ChannelStatusAutoDisabled},
		{name: "local success cannot recover", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusAutoDisabled, LocalError: true}, status: channelcatalog.ChannelStatusAutoDisabled},
		{name: "enabled success unchanged", input: ChannelHealthPolicyInput{Status: channelcatalog.ChannelStatusEnabled}, status: channelcatalog.ChannelStatusEnabled},
	}
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
	...
	got := DecideChannelHealthTransition(policy, ChannelHealthPolicyInput{
		Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, AllowDisable: true,
	...
	got = DecideChannelHealthTransition(policy, ChannelHealthPolicyInput{
		Status: channelcatalog.ChannelStatusEnabled, AutoBan: true, AllowDisable: true, Failure: statusFailure,
	})
...
func TestSelectChannelsForReliabilityTestModes(t *testing.T) {
	...
	channels := []model.Channel{
		{Id: 1, Type: int(channelcatalog.ChannelTypeOpenAI), Status: channelcatalog.ChannelStatusEnabled, Models: "gpt-4", AutoBan: &autoBanOn},
		{Id: 2, Type: int(channelcatalog.ChannelTypeOpenAI), Status: channelcatalog.ChannelStatusAutoDisabled, TestModel: "gpt-4", AutoBan: &autoBanOn},
		{Id: 3, Type: int(channelcatalog.ChannelTypeOpenAI), Status: channelcatalog.ChannelStatusEnabled, Models: "gpt-4", AutoBan: &autoBanOff},
		{Id: 4, Type: int(channelcatalog.ChannelTypeOpenAI), Status: channelcatalog.ChannelStatusManuallyDisabled, Models: "gpt-4", AutoBan: &autoBanOn},
		{Id: 5, Type: int(channelcatalog.ChannelTypeMidjourney), Status: channelcatalog.ChannelStatusEnabled, Models: "mj", AutoBan: &autoBanOn},
		{Id: 6, Type: int(channelcatalog.ChannelTypeOpenAI), Status: channelcatalog.ChannelStatusEnabled, AutoBan: &autoBanOn},
	}
	tests := []struct {
		mode string
		ids  []int
