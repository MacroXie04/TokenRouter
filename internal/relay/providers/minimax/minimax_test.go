...
func miniMaxMeta(mode channelcatalog.RelayMode, format channelcatalog.RelayFormat, modelName string) *relaycommon.Meta {
	request := &protocolkit.GeneralOpenAIRequest{
		Model: modelName,
		Extra: map[string]any{"model": modelName},
	}
	return &relaycommon.Meta{
		Channel:   &model.Channel{Type: int(channelcatalog.ChannelTypeMiniMax)},
		Mode:      mode,
		Format:    format,
		ModelName: modelName,
...
func TestMiniMaxURLsHeadersModesAndCatalog(t *testing.T) {
	tests := []struct {
		...
		{name: "OpenAI chat default", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatOpenAI, want: "https://api.minimax.chat/v1/text/chatcompletion_v2"},
		{name: "OpenAI stream custom", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatOpenAI, stream: true, base: "https://minimax.example/gateway", want: "https://minimax.example/gateway/v1/text/chatcompletion_v2"},
		{name: "Anthropic messages", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatClaude, base: "https://minimax.example", want: "https://minimax.example/anthropic/v1/messages"},
		{name: "image", mode: channelcatalog.RelayModeImagesGenerations, format: channelcatalog.RelayFormatOpenAIImage, want: "https://api.minimax.chat/v1/image_generation"},
		{name: "speech", mode: channelcatalog.RelayModeAudioSpeech, format: channelcatalog.RelayFormatOpenAIAudio, want: "https://api.minimax.chat/v1/t2a_v2"},
	}
	...
	for _, test := range []struct {
		...
		{name: "embeddings", mode: channelcatalog.RelayModeEmbeddings, format: channelcatalog.RelayFormatEmbedding},
		{name: "image stream", mode: channelcatalog.RelayModeImagesGenerations, format: channelcatalog.RelayFormatOpenAIImage, stream: true},
		{name: "speech stream", mode: channelcatalog.RelayModeAudioSpeech, format: channelcatalog.RelayFormatOpenAIAudio, stream: true},
		{name: "image edit", mode: channelcatalog.RelayModeImagesEdits, format: channelcatalog.RelayFormatOpenAIImage},
		{name: "audio transcription", mode: channelcatalog.RelayModeAudioTranscription, format: channelcatalog.RelayFormatOpenAIAudio},
		{name: "gemini", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatGemini},
	} {
	...
	for _, rawBase := range []string{
		...
		meta := miniMaxMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatOpenAI, "MiniMax-M2.7")
...
func TestMiniMaxRequestConversionsUseMappedModelAndProviderFields(t *testing.T) {
	t.Run("chat", func(t *testing.T) {
		meta := miniMaxMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatOpenAI, "MiniMax-M2.7-highspeed")
	...
	t.Run("image", func(t *testing.T) {
		n := 2
		meta := miniMaxMeta(channelcatalog.RelayModeImagesGenerations, channelcatalog.RelayFormatOpenAIImage, "image-01-live")
	...
	t.Run("speech with metadata", func(t *testing.T) {
		meta := miniMaxMeta(channelcatalog.RelayModeAudioSpeech, channelcatalog.RelayFormatOpenAIAudio, "speech-02-hd")
		meta.Request.Extra = map[string]any{
	...
	t.Run("invalid image and speech inputs", func(t *testing.T) {
		...
		image := miniMaxMeta(channelcatalog.RelayModeImagesGenerations, channelcatalog.RelayFormatOpenAIImage, "image-01")
		...
		speech := miniMaxMeta(channelcatalog.RelayModeAudioSpeech, channelcatalog.RelayFormatOpenAIAudio, "speech-02-hd")
...
func TestMiniMaxChatImageAndSpeechResponses(t *testing.T) {
	...
	t.Run("image URL and base64 conversion", func(t *testing.T) {
		meta := miniMaxMeta(channelcatalog.RelayModeImagesGenerations, channelcatalog.RelayFormatOpenAIImage, "image-01")
		meta.PromptTokens = 5
		adaptor := &Adaptor{}
		adaptor.Init(meta)
		recorder := httptest.NewRecorder()
...
func TestMiniMaxProviderErrorsMalformedMediaAndResponseBounds(t *testing.T) {
	...
	imageMeta := miniMaxMeta(channelcatalog.RelayModeImagesGenerations, channelcatalog.RelayFormatOpenAIImage, "image-01")
	...
	speechMeta := miniMaxMeta(channelcatalog.RelayModeAudioSpeech, channelcatalog.RelayFormatOpenAIAudio, "speech-02-hd")
	...
	chatMeta := miniMaxMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatOpenAI, "MiniMax-M2.7")
	chatAdaptor := &Adaptor{}
