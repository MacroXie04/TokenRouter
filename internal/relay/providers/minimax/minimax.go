...
func (a *Adaptor) GetRequestURL(meta *relaycommon.Meta) (string, error) {
	...
	case channelcatalog.RelayFormatOpenAIAudio:
		path = "/v1/t2a_v2"
	default:
...
func validateContract(mode channelcatalog.RelayMode, format channelcatalog.RelayFormat, stream bool) error {
	switch format {
	case channelcatalog.RelayFormatOpenAI, channelcatalog.RelayFormatClaude:
	...
	case channelcatalog.RelayFormatOpenAIAudio:
		if mode != channelcatalog.RelayModeAudioSpeech {
