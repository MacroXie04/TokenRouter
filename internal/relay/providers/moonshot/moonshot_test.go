...
func moonshotMeta(mode channelcatalog.RelayMode, format channelcatalog.RelayFormat) *relaycommon.Meta {
	return &relaycommon.Meta{
		Channel:   &model.Channel{Type: int(channelcatalog.ChannelTypeMoonshot)},
		Mode:      mode,
		Format:    format,
		ModelName: "kimi-k2.5",
...
func TestMoonshotURLsAuthenticationAndModeGates(t *testing.T) {
	tests := []struct {
		...
		{name: "default chat", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatOpenAI, expected: "https://api.moonshot.cn/v1/chat/completions", wantAccept: "application/json"},
		{name: "v1 custom base", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatOpenAI, base: "https://proxy.example/v1/", expected: "https://proxy.example/v1/chat/completions", wantAccept: "application/json"},
		{name: "completions", mode: channelcatalog.RelayModeCompletions, format: channelcatalog.RelayFormatOpenAI, expected: "https://api.moonshot.cn/v1/completions", wantAccept: "application/json"},
		{name: "embeddings", mode: channelcatalog.RelayModeEmbeddings, format: channelcatalog.RelayFormatEmbedding, expected: "https://api.moonshot.cn/v1/embeddings", wantAccept: "application/json"},
		{name: "rerank", mode: channelcatalog.RelayModeRerank, format: channelcatalog.RelayFormatRerank, expected: "https://api.moonshot.cn/v1/rerank", wantAccept: "application/json"},
		{name: "Claude protocol", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatClaude, expected: "https://api.moonshot.cn/anthropic/v1/messages", wantAccept: "application/json"},
		{name: "Kimi coding OpenAI", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatOpenAI, base: kimiCodingPlanBase, expected: "https://api.kimi.com/coding/v1/chat/completions", wantAccept: "application/json"},
		{name: "Kimi coding Claude", mode: channelcatalog.RelayModeChatCompletions, format: channelcatalog.RelayFormatClaude, base: kimiCodingPlanBase, expected: "https://api.kimi.com/coding/v1/messages", wantAccept: "application/json"},
	}
	...
	streamMeta := moonshotMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatOpenAI)
	...
	missingKey := moonshotMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatOpenAI)
	missingKey.APIKey = " "
	...
	for _, invalidBase := range []string{
		...
		meta := moonshotMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatOpenAI)
	...
	unsupported := moonshotMeta(channelcatalog.RelayModeResponses, channelcatalog.RelayFormatOpenAIResponses)
	adaptor := &Adaptor{}
...
func TestMoonshotClaudeRequestConversionUsesMappedModel(t *testing.T) {
	maxTokens := 64
	meta := moonshotMeta(channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatClaude)
