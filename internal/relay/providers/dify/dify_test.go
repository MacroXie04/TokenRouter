...
func TestDifyModelListURLHeadersAndUnsupportedModes(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{channelcatalog.RelayModeCompletions, channelcatalog.RelayFormatOpenAI},
		...
		{channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatClaude},
		{channelcatalog.RelayModeChatCompletions, channelcatalog.RelayFormatGemini},
	} {
		bad := difyMeta()
