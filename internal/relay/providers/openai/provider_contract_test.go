...
func providerMeta(channelType channelcatalog.ChannelType, mode channelcatalog.RelayMode, modelName string) *relaycommon.Meta {
...
func TestProviderDefaultURLsAndHeaders(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "OpenRouter", channelType: channelcatalog.ChannelTypeOpenRouter, expectedURL: "https://openrouter.ai/api/v1/chat/completions", openRouter: true},
		{name: "DeepSeek", channelType: channelcatalog.ChannelTypeDeepSeek, expectedURL: "https://api.deepseek.com/v1/chat/completions"},
		{name: "Mistral", channelType: channelcatalog.ChannelTypeMistral, expectedURL: "https://api.mistral.ai/v1/chat/completions"},
		{name: "xAI", channelType: channelcatalog.ChannelTypeXai, expectedURL: "https://api.x.ai/v1/chat/completions"},
		{name: "SiliconFlow", channelType: channelcatalog.ChannelTypeSiliconFlow, expectedURL: "https://api.siliconflow.cn/v1/chat/completions"},
	} {
		t.Run(test.name, func(t *testing.T) {
			meta := providerMeta(test.channelType, channelcatalog.RelayModeChatCompletions, "upstream-model")
			adaptor := &Adaptor{}
			adaptor.Init(meta)
	...
	deepSeek := providerMeta(channelcatalog.ChannelTypeDeepSeek, channelcatalog.RelayModeCompletions, "deepseek-chat")
	adaptor := &Adaptor{}
	...
	deepSeek.Mode = channelcatalog.RelayModeResponses
	adaptor.Init(deepSeek)
	...
	customV1 := providerMeta(channelcatalog.ChannelTypeMistral, channelcatalog.RelayModeChatCompletions, "mistral-large")
	...
	customExact := providerMeta(channelcatalog.ChannelTypeCustom, channelcatalog.RelayModeChatCompletions, "tenant/deployment")
...
func TestNarrowOpenAIProviderURLsAndModes(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "Perplexity chat", channelType: channelcatalog.ChannelTypePerplexity, mode: channelcatalog.RelayModeChatCompletions, expectedURL: "https://api.perplexity.ai/chat/completions"},
		{name: "Perplexity responses", channelType: channelcatalog.ChannelTypePerplexity, mode: channelcatalog.RelayModeResponses, expectedURL: "https://api.perplexity.ai/v1/responses"},
		{name: "Jina rerank", channelType: channelcatalog.ChannelTypeJina, mode: channelcatalog.RelayModeRerank, expectedURL: "https://api.jina.ai/v1/rerank"},
		{name: "Jina embeddings", channelType: channelcatalog.ChannelTypeJina, mode: channelcatalog.RelayModeEmbeddings, expectedURL: "https://api.jina.ai/v1/embeddings"},
		{name: "Submodel chat", channelType: channelcatalog.ChannelTypeSubmodel, mode: channelcatalog.RelayModeChatCompletions, expectedURL: "https://llm.submodel.ai/v1/chat/completions"},
		{name: "Submodel completions", channelType: channelcatalog.ChannelTypeSubmodel, mode: channelcatalog.RelayModeCompletions, expectedURL: "https://llm.submodel.ai/v1/completions"},
	} {
		t.Run(test.name, func(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{channelType: channelcatalog.ChannelTypePerplexity, mode: channelcatalog.RelayModeEmbeddings},
		{channelType: channelcatalog.ChannelTypeJina, mode: channelcatalog.RelayModeChatCompletions},
		{channelType: channelcatalog.ChannelTypeSubmodel, mode: channelcatalog.RelayModeResponses},
	} {
		meta := providerMeta(test.channelType, test.mode, "mapped-model")
		adaptor := &Adaptor{}
		adaptor.Init(meta)
...
func TestPerplexityRequestConversion(t *testing.T) {
	meta := providerMeta(channelcatalog.ChannelTypePerplexity, channelcatalog.RelayModeChatCompletions, "sonar-pro")
	meta.IsStream = true
...
func TestJinaRequestConversion(t *testing.T) {
	t.Run("embeddings", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeJina, channelcatalog.RelayModeEmbeddings, "jina-embeddings-v3")
		meta.Request.Extra = map[string]any{
	...
	t.Run("rerank", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeJina, channelcatalog.RelayModeRerank, "jina-reranker-v2-base-multilingual")
		meta.Request.Extra = map[string]any{
...
func TestOpenAICompatibleRealtimeURLCarriesEncodedModel(t *testing.T) {
	meta := providerMeta(channelcatalog.ChannelTypeOpenAI, channelcatalog.RelayModeRealtime, "gpt realtime/preview")
...
func TestAzureOpenAIURLVersionAndAuthentication(t *testing.T) {
	...
	meta := providerMeta(channelcatalog.ChannelTypeAzure, channelcatalog.RelayModeChatCompletions, "deployment.name")
	...
	meta.Mode = channelcatalog.RelayModeEmbeddings
	adaptor.Init(meta)
	requestURL, err = adaptor.GetRequestURL(meta)
	require.NoError(t, err)
	...
	meta.Mode = channelcatalog.RelayModeResponsesCompact
	adaptor.Init(meta)
	requestURL, err = adaptor.GetRequestURL(meta)
	require.NoError(t, err)
	...
	meta.Mode = channelcatalog.RelayModeChatCompletions
	meta.BaseURL = "https://resource.openai.azure.com"
...
func TestOpenRouterRequestConversion(t *testing.T) {
	meta := providerMeta(channelcatalog.ChannelTypeOpenRouter, channelcatalog.RelayModeChatCompletions, "anthropic/claude-sonnet-thinking")
	meta.IsStream = true
...
func TestNonChatRequestPreservesModeFieldsWithoutChatLeakage(t *testing.T) {
	meta := providerMeta(channelcatalog.ChannelTypeDeepSeek, channelcatalog.RelayModeEmbeddings, "deepseek-embedding")
	meta.Request.Extra = map[string]any{
		"model": "client-model",
...
func TestDeepSeekRequestConversion(t *testing.T) {
	meta := providerMeta(channelcatalog.ChannelTypeDeepSeek, channelcatalog.RelayModeChatCompletions, "deepseek-v4-pro-max")
	meta.IsStream = true
	meta.Request.Stream = true
	adaptor := &Adaptor{}
	adaptor.Init(meta)
...
func TestMistralRequestConversion(t *testing.T) {
	meta := providerMeta(channelcatalog.ChannelTypeMistral, channelcatalog.RelayModeChatCompletions, "mistral-large-latest")
	meta.IsStream = true
	meta.Request.Stream = true
	meta.Request.Extra = map[string]any{
		"model":                 "client-model",
...
func TestXAIAndSiliconFlowRequestConversion(t *testing.T) {
	xai := providerMeta(channelcatalog.ChannelTypeXai, channelcatalog.RelayModeChatCompletions, "grok-3-mini-high")
	xai.IsStream = true
	...
	silicon := providerMeta(channelcatalog.ChannelTypeSiliconFlow, channelcatalog.RelayModeCompletions, "deepseek-ai/DeepSeek-V3")
	...
	silicon.Mode = channelcatalog.RelayModeImagesGenerations
...
func TestProviderUsageNormalizationAndErrorMapping(t *testing.T) {
	t.Run("xAI non-stream", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeXai, channelcatalog.RelayModeChatCompletions, "grok-3")
		adaptor := &Adaptor{}
		adaptor.Init(meta)
	...
	t.Run("DeepSeek cache usage", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeDeepSeek, channelcatalog.RelayModeChatCompletions, "deepseek-chat")
		adaptor := &Adaptor{}
		adaptor.Init(meta)
	...
	t.Run("SiliconFlow rerank", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeSiliconFlow, channelcatalog.RelayModeRerank, "BAAI/bge-reranker-v2-m3")
		adaptor := &Adaptor{}
		adaptor.Init(meta)
		ctx, recorder := openAITestContext()
	...
	t.Run("Responses usage", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeDeepSeek, channelcatalog.RelayModeResponses, "deepseek-chat")
		adaptor := &Adaptor{}
		adaptor.Init(meta)
		ctx, _ := openAITestContext()
	...
	t.Run("status mapping and bounded error", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeMistral, channelcatalog.RelayModeChatCompletions, "mistral-large")
	...
	t.Run("success status error envelope fails closed", func(t *testing.T) {
		meta := providerMeta(channelcatalog.ChannelTypeOpenRouter, channelcatalog.RelayModeChatCompletions, "openai/gpt-4o")
		adaptor := &Adaptor{}
		adaptor.Init(meta)
		ctx, recorder := openAITestContext()
