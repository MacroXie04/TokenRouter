...
func (a *Adaptor) GetRequestURL(meta *relaycommon.Meta) (string, error) {
	...
	case channelcatalog.RelayModeCompletions, channelcatalog.RelayModeAudioTranscription, channelcatalog.RelayModeAudioTranslation:
...
func (a *Adaptor) ConvertRequest(meta *relaycommon.Meta) ([]byte, error) {
	...
	for name, value := range map[string]*int{
		...
		if value != nil && (*value < 0 || int64(*value) > quotamath.MaxQuota/2) {
...
func validateContract(mode channelcatalog.RelayMode, format channelcatalog.RelayFormat, stream bool) error {
	var expected channelcatalog.RelayFormat
	streamSupported := false
	switch mode {
	case channelcatalog.RelayModeChatCompletions, channelcatalog.RelayModeCompletions:
		expected = channelcatalog.RelayFormatOpenAI
		streamSupported = true
	case channelcatalog.RelayModeEmbeddings:
		expected = channelcatalog.RelayFormatEmbedding
	case channelcatalog.RelayModeResponses:
		expected = channelcatalog.RelayFormatOpenAIResponses
		streamSupported = true
	case channelcatalog.RelayModeAudioTranscription, channelcatalog.RelayModeAudioTranslation:
		expected = channelcatalog.RelayFormatOpenAIAudio
	default:
...
func isCloudflareAudioMode(mode channelcatalog.RelayMode) bool {
	return mode == channelcatalog.RelayModeAudioTranscription || mode == channelcatalog.RelayModeAudioTranslation
}
