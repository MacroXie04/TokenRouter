...
func TestVertexVeoDescriptorCapturesRoutingAndCredential(t *testing.T) {
	...
	assert.Equal(t, channelcatalog.ChannelTypeVertexAi, descriptor.ChannelType)
	...
	channel := &model.Channel{
		Id: 41, Type: int(channelcatalog.ChannelTypeVertexAi), Key: credential,
...
func TestVertexVeoDescriptorAdaptsClientAndInlineContent(t *testing.T) {
	descriptor := vertexVeoProviderDescriptor()
	channel := &model.Channel{Id: 41, Type: int(channelcatalog.ChannelTypeVertexAi), Other: "us-central1"}
