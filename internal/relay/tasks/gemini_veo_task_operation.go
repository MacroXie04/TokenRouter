...
func markGeminiVeoTaskDispatching(task *model.Task, reservation *billingsvc.RelayQuotaReservation) error {
...
func refundRejectedGeminiVeoTask(task *model.Task, reservation *billingsvc.RelayQuotaReservation, reason string) error {
