...
func markSunoTaskDispatching(task *model.Task, reservation *billingsvc.RelayQuotaReservation) error {
...
func refundRejectedSunoTask(task *model.Task, reservation *billingsvc.RelayQuotaReservation, reason string) error {
...
func settleUnknownSunoDispatch(task *model.Task, reservation *billingsvc.RelayQuotaReservation, reason, leaseOwner string) error {
	if task == nil || reservation == nil {
