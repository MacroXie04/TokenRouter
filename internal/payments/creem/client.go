...
// SetCheckoutTransportForTesting replaces only the Creem checkout
...
func SetCheckoutTransportForTesting(transport http.RoundTripper) (restore func()) {
	if transport == nil {
		transport = creemProductionTransport
	}
...
func CreateCheckout(ctx context.Context, config setting.CreemConfig, snapshot billingsvc.CreemCheckoutRequest) (*CheckoutResponse, error) {
