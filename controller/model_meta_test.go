...
func TestModelMetadataCRUDSearchAndEnrichment(t *testing.T) {
	...
	channel := createSearchChannel(t, "model-source", int(constant.ChannelTypeOpenAI), constant.ChannelStatusEnabled, "default", "gpt-meta", "", 1)
	...
	service.SetModelPriceRegistry(map[string]service.ModelPrice{"gpt-meta": {Prompt: 1, Completion: 3}})
...
func TestModelMetadataAuthorization(t *testing.T) {
	r, do, _ := setupChannelRead(t, constant.RoleCommonUser)
