...
func configureControllerAffinity(t *testing.T) string {
	...
	_, _ = service.GetPreferredChannelByAffinity(ctx, "controller-model", "default", nil)
	service.RecordChannelAffinity(ctx, 73, 73)
...
func TestChannelAffinityUsageControllerContractAndRoles(t *testing.T) {
	handler, rootDo, _ := setupChannelRead(t, constant.RoleRootUser)
