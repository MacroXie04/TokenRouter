...
func decodeSMTPSettingsUpdate(c *gin.Context) (smtpSettingsUpdateRequest, error) {
	body, err := common.ReadAllLimited(c.Request.Body, maxSMTPSettingsRequestBytes)
	if err != nil {
...
func UpdateSMTPSettings(c *gin.Context) {
	...
	service.RecordSystemLog(common.GetUserId(c), service.LogTypeManage, "smtp.atomic_update")
