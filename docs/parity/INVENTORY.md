...
| GET /:mode/mj/image/:id | RouteTag('relay') + SystemPerformanceCheck: relay.RelayMidjourneyImage (mode-prefixed MJ) | router/relay-router.go:178-181,209 |
| POST /:mode/mj/submit/action | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,212 |
| POST /:mode/mj/submit/shorten | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,213 |
| POST /:mode/mj/submit/modal | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,214 |
| POST /:mode/mj/submit/imagine | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,215 |
| POST /:mode/mj/submit/change | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,216 |
| POST /:mode/mj/submit/simple-change | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,217 |
| POST /:mode/mj/submit/describe | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,218 |
| POST /:mode/mj/submit/blend | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,219 |
| POST /:mode/mj/submit/edits | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,220 |
| POST /:mode/mj/submit/video | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,221 |
| GET /:mode/mj/task/:id/fetch | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,223 |
| GET /:mode/mj/task/:id/image-seed | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,224 |
| POST /:mode/mj/task/list-by-condition | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,225 |
| POST /:mode/mj/insight-face/swap | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,226 |
| POST /:mode/mj/submit/upload-discord-images | RouteTag('relay') + SystemPerformanceCheck + TokenAuth + Distribute: controller.RelayMidjourney | router/relay-router.go:178-181,227 |
...
| AuthFlow (auth_flows) | One-time short-lived auth ceremony state (OAuth/2FA/passkey/telegram). Fields: Id int64 primaryKey, TokenHash char(64) not null uniqueIndex (HMAC, never persists raw token), Purpose varchar(32) not null (idx_auth_flow_purpose_expiry), Provider varchar(64), Intent varchar(128) (widened from varchar(16) so bounded 30-byte passkey backup-code scopes persist on MySQL/PostgreSQL), UserId (index), SessionId varchar(64) index, Payload text, CreatedAt time.Time, ExpiresAt time.Time not null (idx_auth_flow_purpose_expiry), ConsumedAt *time.Time index. Explicit TableName 'auth_flows'. | model/user.go:119 |
