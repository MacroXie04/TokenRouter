...
func TestClickHouseExternalLogLifecycle(t *testing.T) {
	...
	eventID := "clickhouse-external-" + common.BestEffortRandomAlphanumeric(16)
	record := &Log{
		Id:               int(common.NowTimestamp()),
	...
	defaultEventID := "clickhouse-defaults-" + common.BestEffortRandomAlphanumeric(16)
...
func TestClickHouseLogRetentionExternalDatabaseLifecycle(t *testing.T) {
	...
	suffix := common.BestEffortRandomAlphanumeric(16)
