...
type CustomOAuthProvider struct {
	...
	UserIdField          string    `json:"user_id_field" gorm:"type:varchar(128)"`
	UsernameField        string    `json:"username_field" gorm:"type:varchar(128)"`
	DisplayNameField     string    `json:"display_name_field" gorm:"type:varchar(128)"`
	EmailField           string    `json:"email_field" gorm:"type:varchar(128)"`
...
type UserOAuthBinding struct {
	Id             int       `json:"id" gorm:"primaryKey"`
	UserId         int       `json:"user_id" gorm:"uniqueIndex:ux_user_provider"`
	ProviderId     int       `json:"provider_id" gorm:"uniqueIndex:ux_user_provider;uniqueIndex:ux_provider_userid,priority:1"`
	ProviderUserId string    `json:"provider_user_id" gorm:"type:varchar(256);uniqueIndex:ux_provider_userid,priority:2"`
	CreatedAt      time.Time `json:"created_at"`
}
