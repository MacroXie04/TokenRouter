...
func markHailuoTaskDispatching(task *model.Task, reservation *service.RelayQuotaReservation) error {
...
func refundRejectedHailuoTask(task *model.Task, reservation *service.RelayQuotaReservation, reason string) error {
