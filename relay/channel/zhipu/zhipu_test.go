...
func zhipuMeta(channelType constant.ChannelType, mode constant.RelayMode, format constant.RelayFormat, modelName string) *relaycommon.Meta {
...
func TestZhipuPersistedCatalogURLsAndAuthentication(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "chat", base: "https://zhipu.example/gateway", mode: constant.RelayModeChatCompletions, format: constant.RelayFormatOpenAI, expected: "https://zhipu.example/gateway/api/paas/v4/chat/completions"},
		{name: "embedding", base: "https://zhipu.example", mode: constant.RelayModeEmbeddings, format: constant.RelayFormatEmbedding, expected: "https://zhipu.example/api/paas/v4/embeddings"},
		{name: "image", base: "https://zhipu.example", mode: constant.RelayModeImagesGenerations, format: constant.RelayFormatOpenAIImage, expected: "https://zhipu.example/api/paas/v4/images/generations"},
		{name: "Claude", base: "https://zhipu.example", mode: constant.RelayModeChatCompletions, format: constant.RelayFormatClaude, expected: "https://zhipu.example/api/anthropic/v1/messages"},
		{name: "GLM coding OpenAI", base: "glm-coding-plan", mode: constant.RelayModeChatCompletions, format: constant.RelayFormatOpenAI, expected: "https://open.bigmodel.cn/api/coding/paas/v4/chat/completions"},
		{name: "GLM coding Claude", base: "glm-coding-plan", mode: constant.RelayModeChatCompletions, format: constant.RelayFormatClaude, expected: "https://open.bigmodel.cn/api/anthropic/v1/messages"},
		{name: "international embedding", base: "glm-coding-plan-international", mode: constant.RelayModeEmbeddings, format: constant.RelayFormatEmbedding, expected: "https://api.z.ai/api/coding/paas/v4/embeddings"},
		{name: "Kimi Claude", base: "kimi-coding-plan", mode: constant.RelayModeChatCompletions, format: constant.RelayFormatClaude, expected: "https://api.kimi.com/coding/v1/messages"},
		{name: "Doubao image", base: "doubao-coding-plan", mode: constant.RelayModeImagesGenerations, format: constant.RelayFormatOpenAIImage, expected: "https://ark.cn-beijing.volces.com/api/coding/v3/images/generations"},
	} {
	...
	legacy := zhipuMeta(constant.ChannelTypeZhipu, constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "chatglm_pro")
	...
	v4 := zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "glm-4-plus")
	v4Adaptor := &V4Adaptor{}
	v4Adaptor.Init(v4)
	request = httptest.NewRequest(http.MethodPost, "https://zhipu.example", nil)
	...
	_, err = V4RequestURL("https://user:secret@zhipu.example", constant.RelayModeChatCompletions, constant.RelayFormatOpenAI)
...
func TestZhipuLegacyRequestResponseAndStreamConversion(t *testing.T) {
	topP := 1.0
	temperature := 0.25
	meta := zhipuMeta(constant.ChannelTypeZhipu, constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "chatglm_pro")
...
func TestZhipuV4RequestConversionAndFailClosedModes(t *testing.T) {
	...
	meta := zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "glm-4v-plus")
	meta.IsStream = true
	meta.Request.Stream = true
	meta.Request.TopP = &topP
	...
	embedding := zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeEmbeddings, constant.RelayFormatEmbedding, "embedding-3")
	...
	n := 2
	image := zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeImagesGenerations, constant.RelayFormatOpenAIImage, "cogview-4")
	image.Request.N = &n
	...
	claude := zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeChatCompletions, constant.RelayFormatClaude, "glm-4.7")
	...
	invalid := []*relaycommon.Meta{
		zhipuMeta(constant.ChannelTypeZhipu, constant.RelayModeEmbeddings, constant.RelayFormatEmbedding, "chatglm_pro"),
		zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeCompletions, constant.RelayFormatOpenAI, "glm-4"),
		zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeGemini, constant.RelayFormatGemini, "glm-4"),
		zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeImagesEdits, constant.RelayFormatOpenAIImage, "cogview-4"),
		zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeResponses, constant.RelayFormatOpenAIResponses, "glm-4"),
	}
	for _, candidate := range invalid {
		if candidate.Channel.Type == int(constant.ChannelTypeZhipu) {
			legacyAdaptor := &LegacyAdaptor{}
...
func TestZhipuV4ImageNormalizationUsesBoundedCredentialFreeFetch(t *testing.T) {
	meta := zhipuMeta(constant.ChannelTypeZhipuV4, constant.RelayModeImagesGenerations, constant.RelayFormatOpenAIImage, "cogview-4")
	meta.PromptTokens = 4
	n := 2
	meta.Request.N = &n
