...
func legacyMeta(mode constant.RelayMode) *relaycommon.Meta {
	return &relaycommon.Meta{
		Channel:   &model.Channel{Type: int(constant.ChannelTypeBaidu)},
		Mode:      mode,
		Format:    relaycommon.GetRelayFormat(constant.ChannelTypeBaidu, mode),
...
func TestBaiduLegacyURLsOAuthHeadersAndModelCatalog(t *testing.T) {
	tests := []struct {
		...
		{model: "ERNIE-4.0-8K", mode: constant.RelayModeChatCompletions, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions_pro"},
		{model: "ERNIE-3.5-8K", mode: constant.RelayModeChatCompletions, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions"},
		{model: "ERNIE-Speed-128K", mode: constant.RelayModeChatCompletions, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/ernie-speed-128k"},
		{model: "Embedding-V1", mode: constant.RelayModeEmbeddings, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/embeddings/embedding-v1"},
		{model: "bge-large-zh", mode: constant.RelayModeEmbeddings, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/embeddings/bge_large_zh"},
		{model: "tao-8k", mode: constant.RelayModeEmbeddings, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/embeddings/tao_8k"},
		{model: "custom-model", mode: constant.RelayModeChatCompletions, path: "/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/custom-model"},
	}
	...
	meta := legacyMeta(constant.RelayModeChatCompletions)
	...
	bad := legacyMeta(constant.RelayModeChatCompletions)
	...
	unsupported := legacyMeta(constant.RelayModeImagesGenerations)
...
func TestBaiduLegacyRequestConversion(t *testing.T) {
	...
	embedding := legacyMeta(constant.RelayModeEmbeddings)
	...
	tooLarge := legacyMeta(constant.RelayModeChatCompletions)
...
func TestBaiduLegacyResponsesAndStreamUsage(t *testing.T) {
	...
	stream := legacyMeta(constant.RelayModeChatCompletions)
