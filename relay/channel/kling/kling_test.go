...
func TestFinalUnitDeductionCeilsAndSaturates(t *testing.T) {
	tests := []struct {
		...
		{"2147483647", int(common.MaxQuota), true}, {"2147483648", int(common.MaxQuota), true},
		{"1e999", int(common.MaxQuota), true}, {"1e999999999999999999999", int(common.MaxQuota), true},
