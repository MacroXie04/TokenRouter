...
func TestRequestURLContract(t *testing.T) {
	tests := []struct {
		...
		{"chat", "", "ep-1", constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "https://ark.cn-beijing.volces.com/api/v3/chat/completions"},
		{"bot chat", "https://ark.example/root", "bot-1", constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "https://ark.example/root/api/v3/bots/chat/completions"},
		{"embedding", "https://ark.example", "ep", constant.RelayModeEmbeddings, constant.RelayFormatEmbedding, "https://ark.example/api/v3/embeddings"},
		{"image generation", "https://ark.example", "ep", constant.RelayModeImagesGenerations, constant.RelayFormatOpenAIImage, "https://ark.example/api/v3/images/generations"},
		{"image edit shares generations", "https://ark.example", "ep", constant.RelayModeImagesEdits, constant.RelayFormatOpenAIImage, "https://ark.example/api/v3/images/generations"},
		{"rerank", "https://ark.example", "ep", constant.RelayModeRerank, constant.RelayFormatRerank, "https://ark.example/api/v3/rerank"},
		{"responses", "https://ark.example", "ep", constant.RelayModeResponses, constant.RelayFormatOpenAIResponses, "https://ark.example/api/v3/responses"},
		{"default tts", "", "voice", constant.RelayModeAudioSpeech, constant.RelayFormatOpenAIAudio, defaultTTSURL},
		{"custom tts", "https://tts.example/root", "voice", constant.RelayModeAudioSpeech, constant.RelayFormatOpenAIAudio, "https://tts.example/root/v1/audio/speech"},
		{"coding openai", codingPlanAlias, "ep", constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "https://ark.cn-beijing.volces.com/api/coding/v3/chat/completions"},
		{"coding claude", codingPlanAlias, "ep", constant.RelayModeChatCompletions, constant.RelayFormatClaude, "https://ark.cn-beijing.volces.com/api/coding/v1/messages"},
		{"standard claude conversion", "https://ark.example", "ep", constant.RelayModeChatCompletions, constant.RelayFormatClaude, "https://ark.example/api/v3/chat/completions"},
	}
...
func TestRequestURLRejectsUnsupportedOrUnsafeCoordinates(t *testing.T) {
	tests := []*relaycommon.Meta{
		volcMeta(constant.RelayModeCompletions, constant.RelayFormatOpenAI, "", "ep"),
		volcMeta(constant.RelayModeEmbeddings, constant.RelayFormatEmbedding, codingPlanAlias, "ep"),
		volcMeta(constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "file:///tmp/provider", "ep"),
		volcMeta(constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "https://user:pass@example.com", "ep"),
		volcMeta(constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "https://example.com?secret=1", "ep"),
		volcMeta(constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "", ""),
	}
...
func TestHeadersAndThinkingConversion(t *testing.T) {
	meta := volcMeta(constant.RelayModeChatCompletions, constant.RelayFormatOpenAI, "", "deepseek-r1-thinking")
...
func TestTTSConversionExactDefaultsAndMetadataBounds(t *testing.T) {
	meta := volcMeta(constant.RelayModeAudioSpeech, constant.RelayFormatOpenAIAudio, "", "tts-model")
...
func TestTTSHTTPResponseIsBoundedAndDecoded(t *testing.T) {
	...
	meta := volcMeta(constant.RelayModeAudioSpeech, constant.RelayFormatOpenAIAudio, "https://tts.example", "tts-model")
...
func volcMeta(mode constant.RelayMode, format constant.RelayFormat, base, modelName string) *relaycommon.Meta {
	request := &protocolkit.GeneralOpenAIRequest{Model: modelName, Extra: map[string]any{"model": modelName}}
	return &relaycommon.Meta{Context: context.Background(), Channel: &model.Channel{Type: int(constant.ChannelTypeVolcEngine)},
