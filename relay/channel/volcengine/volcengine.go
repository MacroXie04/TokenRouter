...
func (a *Adaptor) GetRequestURL(meta *relaycommon.Meta) (string, error) {
	...
	if meta.Mode == constant.RelayModeAudioSpeech && base == defaultBaseURL {
...
func (a *Adaptor) SetupRequestHeader(request *http.Request, meta *relaycommon.Meta) error {
	...
	if meta.Mode == constant.RelayModeAudioSpeech {
...
func (a *Adaptor) validate(meta *relaycommon.Meta) error {
	...
	switch meta.Mode {
	case constant.RelayModeChatCompletions, constant.RelayModeEmbeddings,
		constant.RelayModeImagesGenerations, constant.RelayModeImagesEdits,
		constant.RelayModeRerank, constant.RelayModeResponses,
