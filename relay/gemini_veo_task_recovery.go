...
func settlePendingGeminiVeoOperation(task *model.Task, reservation *service.RelayQuotaReservation, operation *model.TaskOperation) error {
	if operation.EncryptedProviderTaskID == "" {
	...
	if err != nil {
		return markGeminiVeoOperationManualReview(operation, "GeminiVeo provider id cannot be decrypted", common.NowTimestamp())
	}
...
func refundPreparedGeminiVeoTaskWithLease(task *model.Task, reservation *service.RelayQuotaReservation,
