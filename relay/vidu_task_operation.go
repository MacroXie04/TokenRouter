...
func markViduTaskDispatching(task *model.Task, reservation *service.RelayQuotaReservation) error {
...
func refundRejectedViduTask(task *model.Task, reservation *service.RelayQuotaReservation, reason string) error {
