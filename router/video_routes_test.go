...
func TestOpenAIVideoRoutesUseImplementedTaskHandlers(t *testing.T) {
	...
	expected := map[string]string{
		...
		"GET /v1/video/generations/:task_id": "controller.RelayTaskFetch",
		"POST /v1/videos/:video_id/remix":    "controller.RelayTask",
		"POST /v1/videos":                    "controller.RelayTask",
		"GET /v1/videos/:task_id":            "controller.RelayTaskFetch",
		"GET /v1/videos/:task_id/content":    "controller.VideoProxy",
	}
