import { SYSTEM_SETTINGS_SECTIONS, type SystemSettingsCategory } from '../../features/system-settings/settings-groups';
import type { User } from '../../shared/api/client';
import type { ModuleAccess } from '../../shared/config/nav-modules';
