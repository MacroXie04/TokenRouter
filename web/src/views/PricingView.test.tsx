...
} from '../features/performance-metrics/performance-metrics';
import { loadPerformanceMetrics, loadPerformanceSummary } from '../features/performance-metrics/performance-api';
import type { PricingCatalog, PricingCatalogItem } from '../features/pricing/catalog';
...
vi.mock('../features/home/PublicNotice', () => ({ PublicNotice: () => null }));
vi.mock('../features/pricing/pricing-api', () => ({
  loadPricingCatalog: vi.fn(),
}));
vi.mock('../features/performance-metrics/performance-api', () => ({
